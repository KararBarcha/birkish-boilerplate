...
import "./chunk-5ZHWJEBW.js";
import "./chunk-PS76RWRV.js";
import "./chunk-LPWXCWM3.js";
...
var NzCheckboxComponent = class _NzCheckboxComponent {
  ...
  ngOnInit() {
    ...
    this.ngZone.runOutsideAngular(() => {
      ...
      (0, import_rxjs.fromEvent)(this.inputElement.nativeElement, "click").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => event.stopPropagation());
    });
  }
  ngAfterViewInit() {
    if (this.nzAutoFocus) {
