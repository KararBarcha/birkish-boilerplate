...
var NzConfigService = class _NzConfigService {
  ...
  getConfigChangeEventForComponent(componentName) {
    return this.configUpdated$.pipe((0, import_operators2.filter)((n) => n === componentName), (0, import_operators2.mapTo)(void 0));
  }
...
var NzIconService = class _NzIconService extends IconService {
  ...
  constructor(rendererFactory, sanitizer, nzConfigService, platform) {
    ...
    this.configUpdated$ = new import_rxjs3.Subject();
...
var NzIconDirective = class _NzIconDirective extends IconDirective {
  ...
  changeIcon2() {
    ...
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs3.from)(this._changeIcon()).pipe((0, import_operators3.takeUntil)(this.destroy$)).subscribe({
        next: (svgOrRemove) => {
          this.ngZone.run(() => {
...
//# sourceMappingURL=chunk-5ZHWJEBW.js.map
