...
import {
  NzToolTipModule,
  NzTooltipDirective
} from "./chunk-B4X6VMCO.js";
import {
  NzI18nService
} from "./chunk-JQLRB3KS.js";
import {
  __decorate
...
import {
  ...
  NzInputDirective,
  NzInputModule
} from "./chunk-SU3PRQT5.js";
import "./chunk-KVFYRNBE.js";
import "./chunk-ZVK5YLV6.js";
import "./chunk-V5C3J2GJ.js";
import "./chunk-CNFPDWD2.js";
import "./chunk-AJYMMHIS.js";
import {
  NzOutletModule,
  NzStringTemplateOutletDirective
} from "./chunk-CQICNRJM.js";
import {
  ENTER,
  ESCAPE
} from "./chunk-GW2MUNDL.js";
import {
  NzDestroyService,
  NzResizeService,
  cancelRequestAnimationFrame,
  reqAnimFrame
} from "./chunk-ASXFQOJK.js";
import "./chunk-IAY7YG5F.js";
import {
  Directionality
} from "./chunk-AGFZ27J2.js";
import {
  NzConfigService,
  NzIconDirective,
  NzIconModule,
  WithConfig
} from "./chunk-5ZHWJEBW.js";
import "./chunk-PS76RWRV.js";
import {
  isStyleSupport,
  measure
} from "./chunk-LPWXCWM3.js";
import {
  Platform
} from "./chunk-BBEUNQWT.js";
...
var NzTextEditComponent = class _NzTextEditComponent {
  ...
  constructor(ngZone, host, cdr, i18n, destroy$) {
    ...
    this.nativeElement = this.host.nativeElement;
    this.textarea$ = new import_rxjs.BehaviorSubject(null);
  ...
  ngOnInit() {
    ...
    this.textarea$.pipe((0, import_operators.switchMap)((textarea) => (
      // Caretaker note: we explicitly should call `subscribe()` within the root zone.
      // `runOutsideAngular(() => fromEvent(...))` will just create an observable within the root zone,
      // but `addEventListener` is called when the `fromEvent` is subscribed.
      textarea ? new import_rxjs.Observable((subscriber) => this.ngZone.runOutsideAngular(() => (0, import_rxjs.fromEvent)(textarea.nativeElement, "keydown").subscribe(subscriber))) : import_rxjs.EMPTY
    )), (0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
    ...
    this.textarea$.pipe((0, import_operators.switchMap)((textarea) => textarea ? new import_rxjs.Observable((subscriber) => this.ngZone.runOutsideAngular(() => (0, import_rxjs.fromEvent)(textarea.nativeElement, "input").subscribe(subscriber))) : import_rxjs.EMPTY), (0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
  ...
  focusAndSetValue() {
    ...
    afterNextRender(() => {
      this.textarea$.pipe(
        ...
        (0, import_operators.first)((textarea) => textarea != null),
...
var NzTypographyComponent = class _NzTypographyComponent {
  ...
  constructor(nzConfigService, host, cdr, viewContainerRef, renderer, platform, i18n, resizeService, directionality) {
    ...
    this.rfaId = -1;
    this.destroy$ = new import_rxjs.Subject();
    this.windowResizeSubscription = import_rxjs.Subscription.EMPTY;
  }
  onTextCopy(text) {
  ...
  renderAndSubscribeWindowResize() {
    if (this.platform.isBrowser) {
      ...
      this.renderOnNextFrame();
      this.windowResizeSubscription = this.resizeService.subscribe().pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => this.renderOnNextFrame());
    }
  }
  ngOnInit() {
    this.i18n.localeChange.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
